...
from DatabaseStuff import add_entries_to_db
...
#     output = print(firstnameMessageBox)
#     newWindow.title("First Names List")
#     newWindow.geometry("300x300")
#     Label(newWindow,
#           text="hello world  ").pack()
#
#     btn = Button(root,
#                  text="Click to see first names ;) ",
...
# def FIRSTNAMEINFO():
#     tkinter.showinfo(firstnameMessageBox)


# B = root.Button(text="Click this button to see list of first names!!", command=FIRSTNAMEINFO())
# #B.pack()
# firstnameMessageBox = c.execute('SELECT first_name FROM WuFooData')
#
# firstname_button = Button(root, text="First name button click here", command=)
...
# def submit(cursor: sqlite3.Cursor, entries_data: list[dict]):
#     conn = sqlite3.connect("cubesProject.sqlite")
#     c = conn.cursor()
#     #insert table into gui
#     cursor.execute(
#         "INSERT INTO prefixtextbox SELECT prefix  ")
#     cursor.commit()
#
#     cursor.close()
...
#
#
#         #    org_websiteLabel.insert('1.0', 'here is my\ntext to insert')
#
#         mainloop()
#
#
